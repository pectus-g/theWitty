...
Shader "NOT_Lonely/NOTLonely_water"
{
	Properties
	{
		...
		[ASEEnd]_DistanceFalloff("Distance Falloff", Float) = 1
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 panner9 = ( ( _TimeParameters.x * 0.05 ) * ( appendResult12 * float2( 0.5,0 ) ) + ( texCoord6 * 2.0 ));
				...
				float distanceDepth35 = saturate( abs( ( screenDepth35 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _IntersectionFading ) ) );
				...
				float2 panner13 = ( ( _TimeParameters.x * 0.05 ) * appendResult12 + texCoord6);
				...
				float cameraDepthFade44 = (( eyeDepth -_ProjectionParams.y - _FadeDistance ) / _DistanceFalloff);
				...
				float Occlusion = 1;
				float Alpha = ( _Color.a * distanceDepth35 * saturate( ( 1.0 - cameraDepthFade44 ) ) );
...
/*ASEBEGIN
Version=18933
0;73;1473;775;697.1682;664.2204;1.70582;True;False
...
ASEEND*/
//CHKSM=496575E737B6DEF55760DEE92F84516D1C98B2CD