...
Shader "NOT_Lonely/Triplanar/One Material (PBR)"
{
	Properties
	{
		...
		[ASEEnd]_TriplanarHardness("Triplanar Hardness", Range( 0 , 25)) = 5
	...
	SubShader
	{
		...
		Pass
		{
			...
			#endif
			CBUFFER_END
			sampler2D _AlbedoRGBSmoothnessA;
			sampler2D _Normal;
			...
			inline float3 TriplanarSampling8( sampler2D topTexMap, float3 worldPos, float3 worldNormal, float falloff, float2 tiling, float3 normalScale, float3 index )
			{
				float3 projNormal = ( pow( abs( worldNormal ), falloff ) );
				projNormal /= ( projNormal.x + projNormal.y + projNormal.z ) + 0.00001;
				float3 nsign = sign( worldNormal );
						 ...
						 ) : SV_Target
			{
				...
				float4 triplanar7 = TriplanarSampling7( _AlbedoRGBSmoothnessA, WorldPosition, WorldNormal, _TriplanarHardness, temp_cast_0, 1.0, 0 );
				
				float2 temp_cast_2 = (_Tiling).xx;
				float3x3 ase_worldToTangent = float3x3(WorldTangent,WorldBiTangent,WorldNormal);
				float3 triplanar8 = TriplanarSampling8( _Normal, WorldPosition, WorldNormal, _TriplanarHardness, temp_cast_2, 1.0, 0 );
				float3 tanTriplanarNormal8 = mul( ase_worldToTangent, triplanar8 );
				
				float3 Albedo = triplanar7.xyz;
				float3 Normal = tanTriplanarNormal8;
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = 0;
				float Smoothness = triplanar7.a;
				float Occlusion = 1;
				float Alpha = 1;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 triplanar7 = TriplanarSampling7( _AlbedoRGBSmoothnessA, WorldPosition, ase_worldNormal, _TriplanarHardness, temp_cast_0, 1.0, 0 );
...
/*ASEBEGIN
Version=18933
0;73;1473;775;1331;252.5;1;True;False
Node;AmplifyShaderEditor.RangedFloatNode;9;-897,45.5;Inherit;False;Property;_Tiling;Tiling;2;0;Create;True;0;0;0;False;0;False;1;0.25;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;10;-999,259.5;Inherit;False;Property;_TriplanarHardness;Triplanar Hardness;3;0;Create;True;0;0;0;False;0;False;5;5;0;25;0;1;FLOAT;0
Node;AmplifyShaderEditor.TriplanarNode;7;-629.5,-70.5;Inherit;True;Spherical;World;False;Albedo(RGB), Smoothness(A);_AlbedoRGBSmoothnessA;white;0;None;Mid Texture 0;_MidTexture0;white;-1;None;Bot Texture 0;_BotTexture0;white;-1;None;Albedo(RGB), Smoothness(A);Tangent;10;0;SAMPLER2D;;False;5;FLOAT;1;False;1;SAMPLER2D;;False;6;FLOAT;0;False;2;SAMPLER2D;;False;7;FLOAT;0;False;9;FLOAT3;0,0,0;False;8;FLOAT;1;False;3;FLOAT2;1,1;False;4;FLOAT;1;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TriplanarNode;8;-609.5,192.5;Inherit;True;Spherical;World;True;Normal;_Normal;bump;1;None;Mid Texture 1;_MidTexture1;white;-1;None;Bot Texture 1;_BotTexture1;white;-1;None;Normal;Tangent;10;0;SAMPLER2D;;False;5;FLOAT;1;False;1;SAMPLER2D;;False;6;FLOAT;0;False;2;SAMPLER2D;;False;7;FLOAT;0;False;9;FLOAT3;0,0,0;False;8;FLOAT;1;False;3;FLOAT2;1,1;False;4;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=6B3C06FCF467E17805801ECC8D6BC7AE802CBA02