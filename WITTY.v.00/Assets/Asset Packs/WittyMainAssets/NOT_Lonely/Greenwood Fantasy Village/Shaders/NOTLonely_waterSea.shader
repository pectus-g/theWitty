...
Shader "NOT_Lonely/NOTLonely_waterSea"
{
	Properties
	{
		...
		[ASEEnd]_FoamIntensity("Foam Intensity", Range( 0 , 10)) = 1
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_FoamTexture = IN.ase_texcoord7.xy * _FoamTexture_ST.xy + _FoamTexture_ST.zw;
				float2 panner50 = ( ( _TimeParameters.x * 0.05 ) * temp_output_14_0 + uv_FoamTexture);
				...
				float2 panner9 = ( ( _TimeParameters.x * 0.05 ) * temp_output_14_0 + ( uv_BumpMap * 2.0 ));
				float3 unpack17 = UnpackNormalScale( tex2D( _BumpMap, panner9 ), _NormalIntensity );
				unpack17.z = lerp( 1, unpack17.z, saturate(_NormalIntensity) );
				float2 panner13 = ( ( _TimeParameters.x * 0.05 ) * appendResult12 + uv_BumpMap);
				float3 unpack19 = UnpackNormalScale( tex2D( _BumpMap, panner13 ), _NormalIntensity );
				unpack19.z = lerp( 1, unpack19.z, saturate(_NormalIntensity) );
				
				float3 Albedo = lerpResult25.rgb;
				float3 Normal = BlendNormal( unpack17 , unpack19 );
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = 0;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 appendResult12 = (float2(_Speed , 0.0));
				float2 temp_output_14_0 = ( appendResult12 * float2( 0.5,0 ) );
				float2 uv_FoamTexture = IN.ase_texcoord2.xy * _FoamTexture_ST.xy + _FoamTexture_ST.zw;
				float2 panner50 = ( ( _TimeParameters.x * 0.05 ) * temp_output_14_0 + uv_FoamTexture);
				float4 tex2DNode22 = tex2D( _FoamTexture, panner50 );
				float lerpResult27 = lerp( tex2DNode22.a , 0.0 , pow( abs( 0.97 ) , _FoamIntensity ));
				float4 lerpResult25 = lerp( _Color , ( _FoamColor * tex2DNode22 ) , lerpResult27);
...
/*ASEBEGIN
Version=18933
0;73;1473;673;1180.256;917.7219;2.24971;True;False
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;1676.366,-185.2747;Float;False;True;-1;2;;0;2;NOT_Lonely/NOTLonely_waterSea;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;18;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForward;False;False;0;;0;0;Standard;38;Workflow;1;0;Surface;0;637769117392106181;  Refraction Model;0;0;  Blend;0;0;Two Sided;1;0;Fragment Normal Space,InvertActionOnDeselection;0;0;Transmission;0;0;  Transmission Shadow;0.5,False,-1;0;Translucency;0;0;  Translucency Strength;1,False,-1;0;  Normal Distortion;0.5,False,-1;0;  Scattering;2,False,-1;0;  Direct;0.9,False,-1;0;  Ambient;0.1,False,-1;0;  Shadow;0.5,False,-1;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;637769160095929914;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;DOTS Instancing;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,-1;0;  Type;0;0;  Tess;16,False,-1;0;  Min;10,False,-1;0;  Max;25,False,-1;0;  Edge Length;16,False,-1;0;  Max Displacement;25,False,-1;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;0;6;False;True;True;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=163B00E97FFD2A044BF537E768E1E7ED4B931509