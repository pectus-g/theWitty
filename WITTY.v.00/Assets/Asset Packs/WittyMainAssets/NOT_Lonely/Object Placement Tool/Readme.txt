...
Object Placement Tool can help you to populate your worlds with many objects using just your mouse right click. 
Simply drag and drop prefabs in the window, add a random to rotation and scale, press Enter Edit Mode and start populating you scene using Ctrl + Right Mouse Button.
